<script lang="ts">
	...
	let styleClass = 'bg-slate-600 hover:bg-slate-700 focus:ring-primary-300/[.2]';
	if (style === 'secondary') {
		styleClass = 'bg-secondary-600 hover:bg-secondary-700 focus:ring-secondary-300/[.2]';
	} else if (style === 'ghost') {
		styleClass =
			'hover:bg-slate-200/[.2] focus:ring-base-300/[.2] hover:bg-slate-700/[.2] focus:ring-base-800/[.2]';
	}

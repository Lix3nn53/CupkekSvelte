<script>
	import SwitchTheme from './switch/SwitchTheme.svelte';
...
<footer class="p-4 shadow md:p-6 bg-stone-800 text-stone-50">
					...
					<div id="mc_embed_signup_scroll">
						<div class="pb-0 h-9 mb-4" style="width: 96%;">
							<input
								type="email"
								name="EMAIL"
								class="required email bg-stone-600 w-full h-9"
								id="mce-EMAIL"
								required=""
								value=""
